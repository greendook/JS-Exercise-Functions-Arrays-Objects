...
console.log(5, 'Leia', 'leia@leia.com');
...
function makeSmartPerson(name) {
  let smartPersonObj = {}
  smartPersonObj.name = name;
  smartPersonObj.sum = function sum(num1, num2) {
    return num1 + num2
  };
  smartPersonObj.speak = function speak() {
...
function getLastCarInfo(inventory) {
  let my_make = inventory[inventory.length - 1].car_make;
  let my_model = inventory[inventory.length - 1].car_model;
...
function getCarInfoById(inventory, id) {
  let my_make = inventory[id - 1].car_make;
  let my_model = inventory[id - 1].car_model;
  return `This is a  ${my_make}  ${my_model}`;
}
